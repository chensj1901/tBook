...
-(void)loadFirstBooks{
    [self.bookService loadFirstBooksWithKeyWord:self.mainView.searchTextField.text success:^{
...
-(void)loadMoreBooks{
    [self.bookService loadMoreBooksWithKeyWord:self.mainView.searchTextField.text success:^{
        [self.mainView.resultTableView reloadData];
